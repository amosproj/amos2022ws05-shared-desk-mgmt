                    ...
                    <div className="flex justify-end">
                        <button
                            ...
                            onClick={() => {
                                ...
                                const changeFloorName = floor.floorName === floorName ? undefined : floorName;
                                const selectedBuilding = building == undefined ? undefined : building;
                                const updateBuildingDto = { floorName: changeFloorName, buildingId: selectedBuilding?.buildingId, };
