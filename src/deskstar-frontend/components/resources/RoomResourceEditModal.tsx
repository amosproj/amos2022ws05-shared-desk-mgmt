                    ...
                    <div className="flex justify-end">
                        <button
                            ...
                            onClick={() => {
                                ...
                                const changeRoomName = room.roomName === roomName ? undefined : roomName;
                                const selectedFloor = !floor || (floor.floorName === room.floor && building?.buildingName == room.building) ? undefined : floor;
                                const updateRoomDto = { roomName: changeRoomName, floorId: selectedFloor?.floorId, };
