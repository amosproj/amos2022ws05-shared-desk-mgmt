          ...
          <div className="flex justify-end">
            <button
              ...
              onClick={() => {
                ...
                const changeDeskName =
                  desk.deskName === deskName ? undefined : deskName;
                const changeRoomId =
                  !room || desk.roomId === room.roomId
                    ? undefined
                    : room.roomId;
                const changeDeskTypeId =
                  desk.deskTyp === deskType?.deskTypeName
                    ? undefined
                    : deskType?.deskTypeId;
                const deskDto = {
                  deskName: changeDeskName,
                  deskTypeId: changeDeskTypeId,
                  roomId: changeRoomId,
                };
